				...
				<div class="row">
					...
					<div class="col-xs-9">
						...
						<div class="page-content row">
							...
							<form id="point-add-form" style="margin-top:40px;"  action="field/addKnowledgePoint">
								<div class="form-line form-field" style="display: block;">
									<span class="form-label"><span class="warning-label"></span>题库：</span>
									<select name="fid" id="field-input-select" class="df-input-narrow">
								...
								<div class="form-line form-name" style="display: block;">
									<span class="form-label"><span class="warning-label"></span>知识点名：</span>
										<input type="text" name="kname" class="df-input-narrow" id="name"><span class="form-message"></span>
									<br>
								</div>
								<div class="form-line form-memo" style="display: block;">
									<span class="form-label"><span class="warning-label"></span>知识点描述：</span>
										<input type="text" name="kdescribe" class="df-input-narrow" id="memo"><span class="form-message"></span>
									<br>
								</div>
		...
		$(function(){
			$.post('field/showField',function(data){
				for(var i=0;i<data.length;i++){
					$("#field-input-select").append("<option value="+data[i].question_id+">"+data[i].question_name+"</option>");
				}
			},'json');
		});
	</script>

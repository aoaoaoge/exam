...
public class ExecriseDao {
	 ...
	 * @return
	 */
	public List<TestQuestions> queryAllUsersOnpage(int pageNo,int pageSize){
		//访问数据库
		Connection con = null;
		...
		try {
			...
			ps = con.prepareStatement("select * from tb_testquestion  limit ?,?");
